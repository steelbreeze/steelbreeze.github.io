...
<html lang="en">
	...
	<body onload="init()">
		...
		<button type="button" onclick="player.process('flip')">flip</button>
		<button type="button" onclick="player.process('off')">off</button>
